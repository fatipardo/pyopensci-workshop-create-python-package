...
Report bugs at https://github.com/fatipardo/pyospackage_fatipardo1/issues.
...
pyospackage_fatipardo1 could always use more documentation, whether as
part of the official documentation, in docstrings, or even on the web in blog
posts, articles, and such. Just
[open an issue](https://github.com/fatipardo/pyospackage_fatipardo1/issues)
to let us know what you will be working on so that we can provide you with guidance.

### Submit Feedback

The best way to send feedback is to file an issue at
https://github.com/fatipardo/pyospackage_fatipardo1/issues. If your feedback fits the format of one of
the issue templates, please use that. Remember that this is a volunteer-driven
project and everybody has limited time.

## Get Started!

Ready to contribute? Here's how to set up pyospackage_fatipardo1 for
local development.

1. Fork the https://github.com/fatipardo/pyospackage_fatipardo1
   repository on GitHub.
2. Clone your fork locally (*if you want to work locally*)

    ```shell
    git clone git@github.com:your_name_here/pyospackage_fatipardo1.git
    ```
